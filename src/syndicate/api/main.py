...
async def execute_workflow(
    workflow_id: str, request: CreateWorkflowRequest, _: str = Depends(verify_api_key)
...
async def get_execution(
    execution_id: str, _: str = Depends(verify_api_key)
) -> WorkflowStatusResponse:
...
async def list_agents(
    division: str | None = None, capability: str | None = None, _: str = Depends(verify_api_key)
) -> AgentListResponse:
